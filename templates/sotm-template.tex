...
{\small \textbf{This ticket is only valid if it is printed out.} It includes a public transport ticket for the whole VRN area from 21 to 23 September 2019. You may use it on all buses, trams, S-Bahn trains and
...
\noinclude\includegraphics{((( png_path))) }
