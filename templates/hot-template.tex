...
%  \fill[color=ochsenblutrot, rounded corners=4mm] (0,0) rectangle (\linewidth, 30);
  ...
  \node at (15,0) [anchor=south west, inner sep=3mm] {%
    \includegraphics[height=24mm]{../templates/images/summit-logo-small.png}%
  };
...
& {\large \textbf{Ticket ID}}
& {\large ((( data['ticket_id']|e )))}
\tabularnewline
\hline
...
\begin{minipage}{0.55\linewidth}%
  \begin{tikzpicture}[x=1mm, y=1mm]
    \node at (0,0) [anchor=south west] {\includegraphics[height=60mm]{../templates/images/ticketkarte128-small.png}};
    \node at (34, 32) [anchor=south] {\includegraphics[]{../templates/images/marker.png}};
